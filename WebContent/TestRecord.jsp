	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-7" id="login-info">
				...
				<a class="btn btn-primary" href="user-register">用户注册</a> <a
					class="btn btn-success" href="user-login-page">登录</a>
	...
	<div class="navbar bs-docs-nav" role="banner">
		<div class="container">
			...
			<ul class="nav navbar-nav">
				...
				<li><a href=""><i class="fa fa-cloud"></i>管理试题</a></li>
				<li><a href=""><i class="fa fa-user"></i>学生管理</a></li>
