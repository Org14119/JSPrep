				...
				<a href="import.jsp" title="从Excel导入"><i class="fa fa-volume-up">&nbsp</i><span class="left-menu-item-name"> 从Excel导入</span></a>
					...
					<div class="col-xs-10">
						<div style="border-bottom: 1px solid #ddd;">
							<h3 class="title"><i class="fa fa-dashboard"></i> 手动添加</h3>
						</div>	
						<div>
		
	<form method="post" action="addObjectQuestion">
		请输入题目内容：<br>
		 <textarea name="questionName" rows="4" cols="80"></textarea><br> <br />
		请输入A选项内容：<br>
		<textarea name="answerA" rows="4" cols="80"></textarea><br> <br />
		请输入B选项内容： <br>
		<textarea name="answerB" rows="4" cols="80"></textarea><br> <br />
		请输入C选项内容：<br>
		<textarea name="answerC" rows="4" cols="80"></textarea><br> <br />
		请输入D选项内容： <br>
		<textarea name="answerD" rows="4" cols="80"></textarea><br> <br />
		请选择正确选项：
		<br> <input type="radio" name="correctAnswer" value="1">A<br>
		...
		请输入答案解析： <br>
		<textarea name="answerAnalyze" rows="4" cols="80"></textarea><br> <br />
						...
						<div class="copy">
							<p>
								在线考试系统 ?<!-- 这里面的 连接是本网站的连接 -->
                                 <a href="＃" target="_blank">在线考试系统</a> - <a href="." target="_blank"></a>
							</p>
						</div>
					</div>
				</div>
